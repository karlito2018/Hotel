...
public class ExelisWamkitxveli {
    public static List<Hotel> chamtvirtavi() throws IOException {
        Workbook workbook = WorkbookFactory.create(new File("C:/Users/karli/Documents/სასტუმრო.xlsx"));
